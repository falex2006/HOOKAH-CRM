...
| Сквозная нагрузочная проверка | `scripts/local-100-orders.ps1` | отдельный локальный прогон `-Count 100` создаёт и закрывает 100 заказов; обычный приёмочный прогон ограничен 3 заказами для экономии ресурсов |
| Единый локальный приёмочный прогон | `scripts/local-acceptance.ps1` | объединяет маршруты, каталог/ТТК, гостей, 3 заказа, финансы, скидки, VIP, доставку и аудит; нагрузочный прогон 100 заказов запускается отдельно |
