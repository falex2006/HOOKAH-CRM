...
| Меню бара и ТТК | `catalog-seed.js`, `output/bar-menu-import-preview.json`, `output/cold-teas-ttk-preview.json`, `/api/products`, `/api/recipes` | локально: 75 товаров и 6 технологических карт |
