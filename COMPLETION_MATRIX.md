...
| Визуальные регрессии CSS, action-ссылок и иконок | Подтверждено локально | `local-design-contract.mjs` — актуальный `style.css?rev=178`, без подчёркиваний, с focus-state и встроенными Tabler Icons |
