...
for (const file of htmlFiles) {
  ...
  assert.match(html, /style\.css\?rev=163/, `${file} must use current CSS cache version`);
...
console.log(`LOCAL DESIGN CONTRACT: PASS (routes=${htmlFiles.length}, CSS rev=163, action links and Tabler Icons)`);
