...
for (const file of htmlFiles) {
  ...
  assert.match(html, /style\.css\?rev=148/, `${file} must use current CSS cache version`);
...
console.log(`LOCAL DESIGN CONTRACT: PASS (routes=${htmlFiles.length}, CSS rev=148, action links and Tabler Icons)`);
